...
public class Q2 extends Verticle {
    ...
    public static int max_sizze = 500000;
    public static long gc_count = 0;
    public static LinkedHashMap<String, String> cache = new LinkedHashMap<String, String>(max_sizze, 1.1f){
        @Override
        public boolean removeEldestEntry(Map.Entry eldest)
        {
            return size() > max_sizze;
        }
    };
